...
export default function SidebarHeader({
  ...
  // The API rejects writes while a managed DingTalk actor is pending or
  // ambiguous, even when the selected deployment profile is otherwise
  // writable. Hide this entry point so it cannot look actionable until
  // identity enrollment has completed.
  const canCreateProject = can('project.mutate')
    && !isReadOnly
